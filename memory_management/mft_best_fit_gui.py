...
try:
    from mft_best_fit_process import MFTBestFit
except Exception:
    from .mft_best_fit_process import MFTBestFit

class TransparentMFTBestFitSimulator(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("MFT: Best-Fit")
    ...
    def setup_layout(self):
        ...
        self.lbl_title = tk.Label(header, text="MFT MEMORY ALLOCATION & ANALYSIS ENGINE (BEST-FIT STRATEGY)", 
        ...
        self.btn_calc = tk.Button(btn_pane, text="▶ Allocate", font=("Comic Sans MS", 10, "bold"), bg="#22c55e", fg="#ffffff", bd=0, width=12, pady=5, command=self.run_best_fit_allocation)
    ...
    def reset_to_defaults(self):
        ...
        self.run_best_fit_allocation()

    def run_best_fit_allocation(self):
        try:
        ...
        try:
            result = MFTBestFit.calculate_allocation(total_mem_limit, part_sizes, process_sizes)
...
if __name__ == "__main__":
    app = TransparentMFTBestFitSimulator()
    app.mainloop()
